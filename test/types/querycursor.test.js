...
Test.find().cursor().
    eachAsync(function (doc) { return __awaiter(void 0, void 0, void 0, function () {
...
Test.find().cursor().
    eachAsync(function (doc, i) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        (0, tsd_1.expectType)(doc._id);
        (0, tsd_1.expectType)(i);
        return [2 /*return*/];
    });
}); }).
    then(function () { return console.log('Done!'); });
Test.find().cursor().next().then(function (doc) { return (0, tsd_1.expectType)(doc); });
function gh14374() {
    return __awaiter(this, void 0, void 0, function () {
        var ParentModel, childSchema, cursor, _a, cursor_1, cursor_1_1, doc, e_1_1;
        var _b, e_1, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    cursor = ParentModel.find({}).populate('child').cursor();
                    _e.label = 1;
                case 1:
